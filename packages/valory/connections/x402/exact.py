...
from packages.valory.connections.x402.chains import get_chain_id
from packages.valory.connections.x402.encoding import (
    safe_base64_decode,
    safe_base64_encode,
)
from packages.valory.connections.x402.types import PaymentRequirements
...
def sign_payment_header(
    ...
    try:
        ...
        typed_data = {
            "types": {
                "EIP712Domain": [  # <-- required for eth-account validation
